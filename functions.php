<?php
/**
 * Boyo functions and definitions
 *
...
if ( ! function_exists( 'boyo_setup' ) ) :
	...
	function boyo_setup() {
		 ...
		 * If you're building a theme based on Boyo, use a find and replace
		 * to change 'boyo' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'boyo', get_template_directory() . '/languages' );
 ...
 */
function boyo_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'boyo_content_width', 680 );
}
add_action( 'after_setup_theme', 'boyo_content_width', 0 );
...
if ( ! function_exists( 'boyo_fonts_url' ) ) :
	/**
	 * Register Google fonts for Boyo.
	 *
	 * @since Boyo 1.0
	 *
...
add_action( 'wp_enqueue_scripts', 'boyo_scripts' );
