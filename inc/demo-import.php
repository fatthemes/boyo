...
function boyo_by_fat_import_files() {
	return array(
		array(
			...
			'import_preview_image_url'     => trailingslashit( get_template_directory_uri() ) . 'inc/demos/1/boyo_masonry_layout_with_sidebar_1.jpg',
		),
		array(
			...
			'import_preview_image_url'     => trailingslashit( get_template_directory_uri() ) . 'inc/demos/2/boyo_classic_layout_with_sidebar_2.jpg',
		),
	);
}
